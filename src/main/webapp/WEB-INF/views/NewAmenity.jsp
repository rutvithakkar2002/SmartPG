				...
				<div class="content-wrapper">
					...
					<form action="saveamenity" method="post">
								<div class="form-group">
									...
									<label>Amenity Name:</label> <input type="text" name="amenityname" placeholder="enter Amenity Name">
								</div>
								<button type="submit" class="btn btn-gradient-primary me-2">Add Amenity</button>
