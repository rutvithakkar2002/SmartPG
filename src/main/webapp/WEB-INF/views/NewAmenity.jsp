	...
	<div
		...
		<div class="main-panel">
			<div class="content-wrapper">
				...
				<form action="saveamenity" method="post">
					<div class="form-group">



						Amenity Name: <input type="text" name="amenityname"
							placeholder="enter Amenity Name"><br><br>
							 <input type="checkbox" id="Amenity1" name="Amenity1" value="Bike"> <label
							for="Amenity1">Garden</label><br> <input
							type="checkbox" id="Amenity2" name="Amenity2" value="Car">
						<label for="Amenity2">Parking</label><br> <input
							type="checkbox" id="Amenity3" name="Amenity3" value="Boat">
						<label for="Amenity3">Wi-fi</label><br>
...
<form method="POST" action="saveamenity">
Amenity Name:<input type="text" name="amenityname"><br><br>
