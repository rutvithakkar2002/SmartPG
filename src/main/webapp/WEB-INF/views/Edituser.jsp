...
<div class="container-scroller">
		...
		<label>	FirstName :</label> <input type="text" name="firstName" placeholder="enter Your FirstName" value="${user.firstName }"/><br><Br>
		<label>	LastName :</label> <input type="text" name="lastName" placeholder="enter Your LastName" value="${user.lastName }"/><br><Br>						
		<label>	Image URL :</label> <input type="text" name="imgurl" placeholder="enter Your Image URL" value="${user.imgurl }"/><br><Br>											
