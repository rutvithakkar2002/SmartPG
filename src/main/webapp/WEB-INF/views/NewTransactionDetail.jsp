					...
					<form method="post" action="savetransactiondetail">
						...
						User id:<select name="userId">
							...
							<c:forEach items="${user}" var="u">
								<option value="${u.userId}">${u.firstName}:${u.lastName}:${p.city}
								</option>

							</c:forEach>
						</select><br>
						<br> payment Id:<select name="paymentid">
						...
						<br> Transaction for:<input type="text" name="transactionfor"><br>
						<br> Amount Paid:<input type="text" name="amountpaid"><br>
						<br> Mode Of Payment:<input type="text" name="modeofpayment"><br>
						<br> Date And Time:<input type="text" name="dateandtime"><br>
						<br> Payment Gateway Used:<input type="text"
							name="paymentgatewayused"><br>
