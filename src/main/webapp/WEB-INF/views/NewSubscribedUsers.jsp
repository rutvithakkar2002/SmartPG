...
<label>subid:</label><select name="subid">
...
<br><br>
<label>Start Date Of Subscription :</label> <input type="text" name="startdateofsub" value="${s.startdateofsubscription}"/><br><Br>
<label>End Date Of Subscription :</label> <input type="text" name="enddateofsub" value="${s.enddateofsubscription}"/><br><Br>
