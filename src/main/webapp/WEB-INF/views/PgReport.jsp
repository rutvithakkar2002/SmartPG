			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" id="exampleModalLabel">PG - Availability</h5>
					...
					<form action="pgavailabilitywisereport">
						<div class="form-group row">
							...
							<div class="col-sm-10">
								<select name="isavailable">
										...
										<option value=2>Is Not Available</option>
