		...
		<div
			...
			<div class="main-panel">
				<div class="content-wrapper">
					...
					<form action="savebookeduser" method="post">
						<div class="form-group">
							...
							</select><br> <br> Pg:<select name="pgid">
							...
							<br> <label>Request Accept:</label><input type="text"
								name="requestaccept"><br> <br> <label>Date
								And Time Of Booking:<label><input type="text"
									name="datetimeofbooking"><br> <br>
						</div>
						<button type="submit" class="btn btn-gradient-primary me-2">Add
							Booked Customer</button>
