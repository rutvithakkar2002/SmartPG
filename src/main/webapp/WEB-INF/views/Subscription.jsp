				...
				<div class="content-wrapper">
					...
					<form action="Subscription" method="post">
								<div class="form-group">
									...
									<label>Time Duration:</label> <input type="text" name="timeduration" placeholder="enter Time-Duration"><br><br>
									<label>Amount:</label> <input type="text" name="amount" placeholder="enter appropriate amount for above time-duration">
								</div>
								<button type="submit" class="btn btn-gradient-primary me-2">Add Plan</button>
